export default class Gui{
    constructor(board_width,board_height,gui_bar_width){
    ...
    update_score(score){
        ...
        //this.Gui.clearRect(this.board_WIDTH,40,this.GUI_BAR_WIDTH,font_size);
        this.Gui.clearRect(0,0,1600,900);
        this.Gui.font =  font_size+"px Arial";
        this.Gui.fillStyle = "white";
        this.Gui.fillText(score,this.BOARD_WIDTH + 10,40);
    }
